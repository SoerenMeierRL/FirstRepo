...
wrld_simpl.AEA <- st_transform(wrld_simpl, 
                        crs = AEA.proj)

# Transform North America polygon
NoAmPoly.AEA <- st_transform(NoAmPoly, crs = AEA.proj)
...
Bigfoot.SpaPnt.AEA <- st_transform(Bigfoot.SpaPnt,
                            crs = AEA.proj)
...
plot(Bigfoot.SpaPnt.AEA$geometry,
     add = TRUE,
     pch = 19,
     col = "red",
     cex = 0.5)
...
NoAm.WC.Bioclim <- crop(WC.Bioclim,
                         NoAmPoly.WGS84)


# Mask to North America shape
NoAm.WC.Bioclim <- mask(NoAm.WC.Bioclim,
                         NoAmPoly.WGS84)
...
#NoAm.WC.Bioclim.AEA <- project(NoAm.WC.Bioclim,AEA.proj,
#filename="wc2.1_10m_bio_1_proj.tif",overwrite=TRUE)
...
ggplot() +
  ...
  # Add title and theme
  ggtitle("Bigfoot Sightings and Annual Mean Temperature") +
  theme_minimal() +
